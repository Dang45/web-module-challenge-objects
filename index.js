...
console.log(createMenuItem("Chicken Cutlet", 10, "Lunch"));
...
createMenuItem("chicken cutlet", 10, "Lunch");
...
reviews.push({name: "Dan", rating: 5, feedback: "the food was really good"});
console.log(reviews);
